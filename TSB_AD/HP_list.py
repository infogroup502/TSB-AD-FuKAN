...
Multi_algo_HP_dict = {
    ...
    'FuKAN': {
        ...
        'lr': [1e-4, 1e-5],
        'epochs': [10, 30],
        'value_weight': [0.0, 1.0, 2.0],
        'normalize_mode': ['window', 'global'],
        'score_agg': ['tail', 'max'],
        'score_smooth': [0.0, 0.1, 0.3],
        'scheduler_type': ['step', 'cosine'],
        'next_step_weight': [0.0, 0.5, 1.0, 2.0],
    },
    'OFA': {
        'win_size': [50, 100, 150]
    },
...
Optimal_Multi_algo_HP_dict = {
    ...
    'FuKAN': {'win_size': 30, 'seq_len': 2, 'local_size': (3,), 'global_size': (7,), 'fuzzy_sets': 4, 'top_k': 3, 'batch_size': 128, 'epochs': 30, 'lr': 5e-4, 'value_weight': 1.0, 'normalize_mode': 'global', 'score_agg': 'max', 'score_smooth': 0.0, 'scheduler_type': 'step', 'next_step_weight': 0.0},
    'OFA': {'win_size': 50},
...
Optimal_Uni_algo_HP_dict = {
    ...
    'FuKAN': {'win_size': 20, 'seq_len': 2, 'local_size': (1,), 'global_size': (10,), 'fuzzy_sets': 4, 'top_k': 1, 'batch_size': 128, 'epochs': 30, 'lr': 5e-4, 'value_weight': 1.0, 'normalize_mode': 'global', 'score_agg': 'max', 'score_smooth': 0.0},
    'OFA': {'win_size': 50},
